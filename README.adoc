...
image:https://img.shields.io/travis/com/gatling/gatling-gradle-plugin/master?logo=travis&style=for-the-badge[Travis (.com) branch, window="_blank", link="https://travis-ci.com/github/gatling/gatling-gradle-plugin/branches"]
...
== Installation
 ...
 . Follow https://plugins.gradle.org/plugin/com.github.lkishalmi.gatling[Gradle
   Plugin Portal] instructions.
